            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="/mysite/admin/modify_race">

                            <div class="form-group">
                                <label>Race Name</label>
                                <input name="txtName" value="<?=$race[0]["raceName"]?>" class="form-control">
                            </div>

                            <div class="form-group">
                                <label>Race Location</label>
                                <input name="txtLocation" value="<?=$race[0]["raceLoc"]?>" class="form-control" >
                            </div>
                            <div class="form-group">
                                <label>Race Description</label>
                                <textarea name="txtDescr" class="form-control" rows="3"><?=$race[0]["raceDescr"]?></textarea>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                <label>Race Date</label>
                                <input name="txtDate" value="<?=$race[0]["raceDateTime"]?>" class="form-control"></div>
                            </div>
                                <br>
